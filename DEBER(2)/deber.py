...
while True:
    try:
        print("*"*10,"MENU","*"*10)
        opcion = int(input("Ingrese el ejercicio que desea ejecutar (1-33): "))
        if opcion < 0 or opcion > 40:
            ...
            os.system("cls")   
            textocs = "wenas tardes bienvenidos a la tarea de carlos sanchez"

            print(textocs)
            print(textocs.lower())
            print(textocs.upper())
            print(textocs.title())
            print(textocs.find("rd"))
            print(textocs.count("o"))
            ...
            print(tuplafin.count(56))
            print(tuplafin.index(8))
            ...
            LISTA1.append("merzian")
            print(LISTA1)

            LISTA1.insert(4, "guayakill")
            print(LISTA1)

            LISTA1.extend(["pepe", 564, False])
            print(LISTA1)

            print(LISTA1.index("joel"))
            ...
            DICCsUNEMI["Peru"] = "Lima"
            print(DICCsUNEMI)

            DICCsUNEMI["Ecuador"] = "Quito"
            print(DICCsUNEMI)

            del DICCsUNEMI["Ecuador"]
            print(DICCsUNEMI)
            ...
            MISDATOS = {"Apellido": "García", "Tiempo": {1: 2009, 2: 2010, 3: 2011, 4: 2012, 5: 2013}}
            print(MISDATOS)
            print(MISDATOS["Tiempo"])

            print(MISDATOS.get('lido', "Carlos"))
            ...
            if (DISTANCIA > 1000 and NUMHERM > 4) or SALARIOP < 2000:
                BENEFICIO = True
            ...
            if materia in ("Fisica", "Quimica", "Historia", "Ingles"):
                print("Materia {0} seleccionada.".format(materia))
            else:
            ...
            class Curso():
                ...
                def mostrarDatos(self):
                    dat = "Nombre: {0} / Créditos: {1} / Modalidad: {2}"
            ...
            per1 = Persona("sanchez", "galan", "joel")
            ...
            CIUDAD1 = Ciudad("Guayakill", 50000000, PAIS1)
            print(CIUDAD1)

            URB1 = Urbanizacion("Ciudad Celeste", CIUDAD1)
            print(URB1)
